          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left">
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Phone" aria-label="Phone" aria-describedby="phone-addon" name="phone" value="{{ old('phone') }}">
                  @error('phone')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Avatar" aria-label="Avatar" aria-describedby="avatar-addon" name="avatar" value="{{ old('avatar') }}">
                  @error('avatar')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Date of Birth" aria-label="Date of Birth" aria-describedby="dob-addon" name="date_of_birth" value="{{ old('date_of_birth') }}">
                  @error('date_of_birth')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
