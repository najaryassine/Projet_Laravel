...
{
    // Fetch complaint data and pass it to the PDF view
    $data = ['attributes' => $complaint->attributesToArray()];

    // Remove the 'created_at' and 'updated_at' attributes
    ...
    // Download the PDF with a filename based on the subject
